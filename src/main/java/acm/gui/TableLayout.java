 ...
 */
	private Dimension getMinimumScrollbarSize(Component comp) {
		...
		try {
			...
			Method getOrientation = scrollbarClass.getMethod("getOrientation");
			int orientation = (Integer) getOrientation.invoke(comp, new Object[0]);
...
/* Private instance variables */
	...
	private final HashMap<Component,GridBagConstraints> constraintTable;
	private HashMap<Component,TableConstraints> layoutTable;
	private final HashMap<String,Object> propertyTable;
