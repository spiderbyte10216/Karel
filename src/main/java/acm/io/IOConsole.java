 ...
 */
	public boolean isConsoleMenuItem(JMenuItem item) {
		...
		for (String consoleMenuAction : CONSOLE_MENU_ACTIONS) {
			if (cmd.equals(consoleMenuAction)) return true;
		}
		return false;
	}
...
/* Method signatures */
void setConsole(IOConsole owner);
 ...
 */
	public void paste() {
		...
		if (document instanceof DefaultStyledDocument doc) {
 ...
 */
	public void setInputStyle(int style) {
		...
		inputAttributes.addAttribute(StyleConstants.Bold, (style & Font.BOLD) != 0);
		inputAttributes.addAttribute(StyleConstants.Italic, (style & Font.ITALIC) != 0);
	}
 ...
 */
	public void setErrorStyle(int style) {
		...
		errorAttributes.addAttribute(StyleConstants.Bold, (style & Font.BOLD) != 0);
		errorAttributes.addAttribute(StyleConstants.Italic, (style & Font.ITALIC) != 0);
	}
...
/* Private instance variables */
	...
	private final ConsoleOutputMonitor outputMonitor;
	private final ConsoleInputMonitor inputMonitor;
	private BufferedReader inputScript;
	private final CharacterQueue buffer;
	private final SimpleAttributeSet outputAttributes;
	private final SimpleAttributeSet inputAttributes;
...
/* Private instance variables */
	private final StandardConsoleModel consoleModel;
}
