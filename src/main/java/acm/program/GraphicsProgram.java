 ...
 */
	protected boolean isStarted() {
		if (gc == null || super.isStarted()) return true;
...
/* Private instance variables */
	...
	private final GProgramListener eventListener;
}
...
/* Private instance variables */
	private final GraphicsProgram myProgram;
 ...
 */
	protected void runHook() {
		...
		try {
			...
			setTitle(className);
			Method run = gobjClass.getMethod("run");
