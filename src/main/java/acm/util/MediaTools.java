...
/* Private package variables */
	...
	private static final HashMap<String,Image> imageTable = new HashMap<>();
	private static final HashMap<String,AudioClip> audioClipTable = new HashMap<>();
	private static final HashMap<String,ImageSaver> suffixTable  = new HashMap<>();
 ...
 */
	public SunAudioClip(InputStream in) {
		...
		try {
			...
			audioData = getData.invoke(audioStream);
	...
	private static void initStaticData() {
		try {
			...
			Class<?> audioStreamClass = Class.forName("sun.audio.AudioStream");
			Class<?> audioDataClass = Class.forName("sun.audio.AudioData");
			Class<?> audioDataStreamClass = Class.forName("sun.audio.AudioDataStream");
			Class<?> continuousAudioDataStreamClass = Class.forName("sun.audio.ContinuousAudioDataStream");
			Class[] inputStreamTypes = { Class.forName("java.io.InputStream") };
...
/* Private instance variables */
	...
	private final String[] psPreview;
}
 ...
 */
	private void calculateOffsets() {
		int offsetNullIFD = HEADER_SIZE + IFD_OP_COUNT * 12 + 2;
